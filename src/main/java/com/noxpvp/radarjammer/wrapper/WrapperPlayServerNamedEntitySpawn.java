/*
 * PacketWrapper - Contains wrappers for each packet in Minecraft. Copyright (C) 2012 Kristian S. Stangeland
 * 
...
public class WrapperPlayServerNamedEntitySpawn extends AbstractPacket {
	 ...
	 * <p>
	 * Note that the 1.3 client crashes on packets with no metadata, but the server can send any metadata key of 0, 1 or
	 * 8 and the client is fine.
	 * 
